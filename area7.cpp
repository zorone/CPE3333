...
{	
	...
	std::println(STDOUT, "Enter the radius and length of a cylinder:");
	...
	std::println(STDOUT, "The area is {}"), area;
	std::println(STDOUT, "The volume is {}"), volume;
	return 0;	
}
